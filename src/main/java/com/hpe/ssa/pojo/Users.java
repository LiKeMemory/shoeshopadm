...
public class Users {
	...
	public Users(int uid, String uaccount, String uname, String utel, String ugender, String upwd, String uemail,
				 Date uregtime, float uintegral, int udelete, String uinfo, String uremarks) {
		this.uid = uid;
