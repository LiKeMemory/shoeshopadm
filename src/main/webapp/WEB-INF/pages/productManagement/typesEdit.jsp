        ...
        <div class="row">
            <form class="form-horizontal col-sm-offset-2" id="editypeinfo" method="post" >
                <div class="form-group">
                    <label for="tid" class="col-sm-2 control-label">类型编号：</label>
                    <div class="col-sm-4">
                    ...
                    <label for="tdelete" class="col-sm-2 control-label">状态：</label>
                    <div class="col-sm-4">
...
<script>
    ...
    function setTypeDetail() {
        ...
        $("input[name='tid']").val(type.tid);
        $("input[name='tname']").val(type.tname);
        $("input[name='tdelete'][value='type.tdelete']").attr("checked",true);
        $("input[value="+type.tdelete+"]").attr("checked",'checked');
        $("input[name='tremarks']").val(type.tremarks);
    }

    function editypeinfo() {
        $.ajax({
            url : "update/type",
            type : "POST",
            async : "true",
